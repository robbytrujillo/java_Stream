...
//        System.out.println(collect);
    ...
    void testGroupingBy2() {
        Map<String, List<String>> map = Stream.of("Robby", "Ilham", "Kusuma", "Programmer", "Zaman", "Now")
    ...
    void testPartitioningBy2() {
        Map<Boolean, List<String>> map = Stream.of("Robby", "Ilham", "Kusuma", "Programmer", "Zaman", "Now")
                .collect(Collectors.groupingBy(name -> {
